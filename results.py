...
def compareAll(user_nodes, C, B, Biz, user_credibility, b_new_score, peer_weight=0.6):
  diff_peer = []
  diff_yelp = []
  num_peers = []
  diff_biz = []
  ...
  for user in user_nodes:
    ...
    for business in B.neighbors(user):
      ...
      avg_peer_value = total*peer_weight+o_total*(1-peer_weight)
...
def compareIterations(user_nodes, C, B, Biz, user_credibility, b_new_score, iteration=10000):
  # analysis
  diff_peer = []
  diff_yelp = []
  num_peers = []
